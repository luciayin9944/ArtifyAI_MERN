...
const Description = () => {
  return (
    <div className="flex flex-col items-center justify-center my-24 p-6 md:px-28 mt-40">
        <h1 className="text-3xl sm:text-4xl font-semibold mb-2">Create <span className='text-lime-700'>AI</span> Images</h1>
        <p className="text-lg text-gray-400 mb-8">Turn your imagination into visuals</p>
